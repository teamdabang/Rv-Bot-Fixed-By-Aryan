...
class Config(object):
    ...
    #tg bot token
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7209702780:AAEC3bfXbhjvJdwm0xEllMmoeKMR0poQmj8")
    ...
    END_NAME = os.environ.get("END_NAME", "AJ_TVSERIAL")
    METADATA_NAME = os.environ.get("METADATA_NAME", "AJ_TVSERIAL")
